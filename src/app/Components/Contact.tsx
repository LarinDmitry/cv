...
const Contact = () => {
  ...
  return (
    <section
      className="relative w-full md:min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-black/80 via-gray-900/80 to-black/80 z-10"
      id="contact"
    >
      <div className="max-w-7xl w-full px-4">
        {/* Header Section */}
        <motion.div className="text-center mb-8 md:mb-16" initial="hidden" animate={mainControls}>
          {/* Floating badge */}
          <motion.span
          ...
          >
            My inbox is always open. Whether you have a question, opportunity, or just want to say hi, I&apos;ll do my
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <a href="tel:+380938839926" className="flex items-center gap-3 md:gap-4 flex-1 min-w-0">
                  <motion.div
                ...
                <motion.button
                  onClick={() => copyToClipboard('+380938839926', 'phone')}
              ...
              >
                <a href="mailto:larin.dm.an@gmail.com" className="flex items-center gap-3 md:gap-4 flex-1 min-w-0">
                  <motion.div
                    className="p-2 md:p-3 bg-violet-900/30 rounded-lg flex-shrink-0"
                    whileHover={{rotate: [0, -10, 10, 0], scale: 1.1}}
                    transition={{duration: 0.3}}
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-base md:text-lg text-white font-semibold group-hover:text-violet-400 transition-colors truncate">
                      larin.dm.an@gmail.com
                    </p>
                  </div>
                </a>
                <motion.button
                  onClick={() => copyToClipboard('larin.dm.an@gmail.com', 'email')}
                  className="p-2 rounded-lg bg-gray-600/50 hover:bg-violet-900/50 transition-colors flex-shrink-0 z-10"
                  whileHover={{scale: 1.1}}
                  whileTap={{scale: 0.95}}
            ...
            >
              ...
              >
                <motion.a
                  href="mailto:larin.dm.an@gmail.com"
                ...
                >
                  <motion.div
                    ...
                    transition={{duration: 0.5}}
                  />
                  <span className="relative z-10 text-violet-400 group-hover:text-violet-300 font-bold text-sm md:text-base whitespace-nowrap transition-colors">
                    Say Hello!
                  </span>
