        ...
        >
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            >
              ...
              >Tech Lead Front-End</motion.span> with over {yearsOfExperience} years of experience
              turning complex problems into elegant, user-friendly solutions. Currently leading front-end development
              at <motion.span
                className="text-violet-400 font-semibold"
                whileHover={{ scale: 1.05 }}
              >Mascode</motion.span>, where I architect cutting-edge healthcare platforms
