    ...
    >
      <div className="max-w-7xl w-full px-4">
        ...
        <motion.div className="text-center mb-8 md:mb-16" initial="hidden" animate={mainControls}>
          ...
          >
            A selection of companies and projects I&apos;ve contributed to, showcasing diverse technical challenges and
            solutions.
          </motion.p>
        </motion.div>

        {/* Projects Grid */}
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
            ...
            >
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <p className="text-gray-300 text-base leading-relaxed mb-4 flex-grow">{project.description}</p>
