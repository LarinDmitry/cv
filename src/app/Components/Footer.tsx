      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-8">
          ...
          <div className="flex flex-col items-center md:items-end gap-3">
            ...
            <div className="flex items-center gap-4 bg-gray-700/50 px-6 py-3 rounded-xl border border-gray-500 transition-all duration-300">
              <a
        ...
        <div className="text-center pt-8 border-t border-gray-800/50">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Larin Dmytro. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
