...
const Header = () => {
  ...
  const closeMobileMenu = useCallback(() => {
    closeMenuRef.current && closeMenuRef.current();
  ...
  useEffect(() => {
    ...
    const handleClickOutside = ({target}: MouseEvent) => {
      mobileMenuOpen && headerRef.current && !headerRef.current.contains(target as Node) && closeMobileMenu();
    };
    ...
    >
      <Disclosure>
        {({open, close}) => {
          ...
          open !== mobileMenuOpen && setTimeout(() => setMobileMenuOpen(open), 0);
                ...
                <div className="relative flex items-center justify-between">
                  ...
                  <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    >
                      ...
                      <span className="hidden md:block text-white font-bold text-lg">Larin Dmytro</span>
                    </motion.button>
