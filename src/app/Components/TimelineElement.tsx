...
const TimelineElement = ({item}: Iitem) => {
  ...
  return (
    <div ref={ref} className="vertical-timeline-element">
      ...
      >
        ...
        >
          <p className="!mt-0 !font-normal !text-base !text-gray-100 !leading-relaxed">{item.description}</p>
        </motion.div>
        <motion.button
        ...
        >
          {isExpanded ? (
            <>
              <span>See less</span>
              <motion.div initial={false} animate={{rotate: 0}} transition={{duration: 0.2}}>
